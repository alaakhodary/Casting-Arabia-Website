...
import { LearningCenterData } from "../../../mock/LearningCenter";
      ...
      <div className="mb-6 flex items-center justify-between pr-4">
        ...
        <div className="flex gap-8">
          ...
          <button
            ...
            disabled={activeIndex === LearningCenterData.length - 1}
          >
            <ArrowForwardIosIcon
              style={{
                color:
                  activeIndex === LearningCenterData.length - 1
                    ? "#888888"
                    : "rgb(99, 113, 224)",
              }}
            />
        ...
        {LearningCenterData.map((item, index) => (
          <SwiperSlide key={item.id} virtualIndex={index}>
            <div className="cursor-pointer">
              ...
              />
              <p className="mb-2 mt-4 px-3 text-base text-[#444444]">
                {item.description}
              </p>
            </div>
          </SwiperSlide>
